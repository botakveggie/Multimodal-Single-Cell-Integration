...
def get_train_arguments():
    ...
    parser.add_argument('--components', default=240, help='insert number of components', type=float)
    parser.add_argument('--neighbours', default=50, help='insert number of neighbours', type=float)
    parser.add_argument('--min_dist', default=0.5, help='insert number of min distance', type=float)
