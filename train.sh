...
python3 ./main/train_final.py --inputs_path 'data/train_cite_inputs_umap200501.csv' --targets_path 'data/train_cite_targets.csv' --model_path 'model/model_umap200501.pth'
